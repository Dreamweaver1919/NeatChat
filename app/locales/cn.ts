...
const cn = {
  ...
  ArtifactLibrary: {
    ...
    ItemCount: (count: number) => `共 ${count} 个文件`,
    Loading: "正在加载文件...",
    Empty: "暂未保存文件。",
    ...
    Download: "下载",
    Delete: "删除",
    DeleteConfirm: (name: string) => `确认从文件库删除 ${name}？`,
    UnsupportedPreview: "暂不支持预览此文件。",
    Sheet: "工作表",
    Slide: "幻灯片",
    ArchiveEmpty: "压缩包为空。",
    BinaryPreview: "二进制预览",
    Type: "类型",
    Size: "大小",
    PreviewTruncated: "为保持流畅，预览内容已截断。",
    PdfLoading: "正在加载 PDF 预览...",
    PdfControls: "PDF 控件",
    PreviousPage: "上一页",
    NextPage: "下一页",
    ZoomOut: "缩小",
    ...
    PdfUnavailable: "无法预览 PDF，请下载原始文件后打开。",
    PdfPasswordProtected: "PDF 已受密码保护，请下载原始文件后打开。",
    LoadError: "无法加载文件库。",
    MissingFile: "保存的文件不可用。",
    PreviewError: "无法加载预览。",
    DownloadError: "无法准备下载。",
    DeleteError: "无法删除此文件。",
    ClosePreview: "关闭预览",
    BackToLibrary: "返回文件库",
    Errors: {
