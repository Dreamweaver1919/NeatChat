...
const en: LocaleType = {
  ...
  ArtifactLibrary: {
    Title: "Artifacts",
    Subtitle: "Files saved from your conversations.",
    Search: "Search artifacts",
    SearchPlaceholder: "Search files",
    FilterLabel: "Artifact type",
    Filters: {
      All: "All",
      Document: "Documents",
      Code: "Code",
    ...
    ItemCount: (count: number) => `${count} artifacts`,
    ...
    Download: "Download",
    Delete: "Delete",
    DeleteConfirm: (name: string) => `Delete ${name} from the library?`,
    UnsupportedPreview: "Preview is not supported for this file.",
    Sheet: "Sheet",
    Slide: "Slide",
    ...
    Type: "Type",
    Size: "Size",
    PreviewTruncated: "Preview truncated to keep interaction responsive.",
    ...
    PdfPasswordProtected:
      "This PDF is password protected. Download the original file to open it.",
    LoadError: "Artifacts could not be loaded.",
    MissingFile: "The saved file is unavailable.",
    PreviewError: "The preview could not be loaded.",
    DownloadError: "The download could not be prepared.",
    DeleteError: "The artifact could not be deleted.",
    ClosePreview: "Close preview",
    BackToLibrary: "Back to library",
    Errors: {
      Unsupported: "Unsupported file type",
      FileTooLarge: "File is too large",
      LibraryFull: "Artifact library storage is full",
      WriteFailed: "Artifact library could not save the file",
    },
  },
  Select: {
    Search: "Search",
